...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    static final LatLng marker1 = new LatLng(52.253649, 76.981428); // Маркер Школы №26
    static final LatLng marker2 = new LatLng(52.26606, 76.981266); // Маркер микрорайона Сарыарка
    static final LatLng marker3 = new LatLng(52.250944, 76.987693); // Маркер ТубДиспансера
    static final LatLng marker4 = new LatLng(52.244511, 76.993089); // Маркер Школы №21
    static final LatLng marker5 = new LatLng(52.259866, 76.991395); // Маркер парка Металлургов
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        mMap.addMarker(new MarkerOptions().position(marker1).title(getString(R.string.marker1_title)).icon(
                BitmapDescriptorFactory.fromResource(R.drawable.soch26)).alpha(ALPHA).
        ...
        mMap.addMarker(new MarkerOptions().position(marker2).title((getString(R.string.marker2_title))).icon(
                BitmapDescriptorFactory.fromResource(R.drawable.sariarka)).alpha(ALPHA).
        ...
        mMap.addMarker(new MarkerOptions().position(marker3).title((getString(R.string.marker3_title))).icon(
                        BitmapDescriptorFactory.fromResource(R.drawable.tub)).alpha(ALPHA).
        ...
        mMap.addMarker(new MarkerOptions().position(marker4).title((getString(R.string.marker4_title))).icon(
                        BitmapDescriptorFactory.fromResource(R.drawable.sosh21)).alpha(ALPHA).
